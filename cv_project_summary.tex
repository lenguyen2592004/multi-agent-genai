...
\begin{itemize}[leftmargin=*]
    \item \textbf{Technologies:} Using Python, FastAPI, and LangGraph to build a multi-agent RAG platform with SQLite and a JSON vector store for retrieval, pypdf for PDF parsing, Vanilla HTML/CSS/JavaScript for the UI, and Docker with Google Cloud Run/Cloud Build for deployment; supports Groq, Ollama, Gemini, and OpenAI-compatible LLMs.
\end{itemize}
